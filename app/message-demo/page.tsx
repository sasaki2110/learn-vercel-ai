...
/**
 * 4.1 Messageコンポーネントのサンプル
 * 
 * このページは、AI ElementsのMessageコンポーネントの基本的な使用方法を示しています。
 * 
 * 主なポイント:
...
export default function MessageDemoPage() {
  ...
  return (
    <div className="container mx-auto p-8 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">4.1 Messageコンポーネント サンプル</h1>
        <p className="text-gray-600 dark:text-gray-400">
          AI ElementsのMessageコンポーネントを使用した基本的なチャットインターフェース
        </p>
      </div>

      {/* メッセージ表示エリア */}
      <div className="space-y-4 mb-6 min-h-[400px] p-4 border rounded-lg bg-gray-50 dark:bg-gray-900">
        {messages.length === 0 && (
          <div className="text-center text-gray-500 mt-20">
            <p>メッセージを入力して会話を始めましょう</p>
            <p className="text-sm mt-2">
              Messageコンポーネントがメッセージを表示します
            </p>
          </div>
        )}
